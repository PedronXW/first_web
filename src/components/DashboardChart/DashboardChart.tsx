const DashboardChart = () => {
    return (
        <section title="Grafíco da quantidade de chamadas nos últimos 30 dias" className="lg:w-5/6 w-full min-h-[350px] flex justify-end">
            ...
            <div className="h-full grow-1 mt-7 w-full rounded-lg self-end border-[1px] border-primary_color bg-white drop-shadow-3xl align-bottom lg:mr-6">
