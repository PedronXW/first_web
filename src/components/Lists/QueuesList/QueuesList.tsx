...
const QueuesList = () => {
    ...
    const [queues, setQueues] = useState([1, 2, 3, 4, 5, 6, 7]);
    ...
    return (
        <ul ref={ref} onDrop={drop} onDragOver={handleDragOver} className="grid md:grid-cols-auto md:h-min h-full grid-cols-1 w-full md:px-12 pl-7 pr-6 pb-4 gap-10">
