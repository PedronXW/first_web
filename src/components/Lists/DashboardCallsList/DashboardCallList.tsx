const DashboardCallList = () => {
    return (
        <section title="Lista das chamadas recebidas hoje" className="w-full md:w-2/6 min-h-[350px] min-w-[280px] max-w-[280px] mt-8 lg:mt-0 flex justify-end">
            ...
            <div className="h-full mt-7 w-full rounded-lg self-end border-[1px] border-primary_color bg-white drop-shadow-3xl align-bottom lg:mr-6">
