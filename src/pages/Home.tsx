    ...
    return (
        <div className="h-screen w-screen flex">
            ...
            <section title="Dashboard" className="h-screen w-full grow-1 flex flex-col">
                <Header />
                <HeaderMobile />
                <div className="h-full w-full grow-1 flex flex-col md:p-12 pb-3 pl-7 pr-6 md:pt-0 overflow-y-scroll lg:overflow-hidden gap-10">
                    ...
                    <div className="w-full grow-1 h-full flex-col lg:flex-row flex gap-10" onClick={()=>{actions(addNotification())}}>
                        <DashboardChart/>
                        <DashboardRamalList/>
                    </div>
                </div>
