    ...
    return(
        <div className="h-screen w-screen flex">
            ...
            <div className="h-screen w-full grow-1 flex flex-col">
                <Header/>
                <HeaderMobile/>
                <div className="h-full w-full grow-1 flex flex-col md:p-12 pb-3 pl-12 pr-6 md:pt-0 overflow-y-scroll gap-8">
                    ...
                    <div className="w-full min-h-[600px] grow-1 bg-red-500">
