...
const Home = () => {
    ...
    return (
        <div className="h-screen w-screen flex flex-col md:grid md:grid-cols-[240px_auto]">
            <Drawer selected={0} />
            <section title="Dashboard" className="h-screen w-full flex flex-col overflow-hidden">
                ...
                <div className="w-full grow-1 flex flex-col md:p-12 pb-3 pl-7 pr-6 md:pt-0 overflow-y-scroll lg:overflow-hidden gap-10">
                    ...
                    <div className="w-full grow-1 flex-col lg:flex-row flex gap-10 mb-20 md:mb-0" onClick={() => { enqueueSnackbar("ArrozDoce", { variant: 'success' }) }}>
                        <DashboardChart />
                        <DashboardRamalList />
                    </div>
                </div>
